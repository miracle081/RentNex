...
import { Text, View, TextInput, Alert, TouchableOpacity, Image, Pressable, ScrollView, StyleSheet, Dimensions, FlatList, StatusBar, SafeAreaView, } from "react-native";
                ...
                <ScrollView contentContainerStyle={{ flex: 1 }} >
                    <View style={styles.formContainer}>
                        ...
                        <View style={{ marginTop: 10, }}>
                            <AppButton onPress={makeAPost}>Create</AppButton>
                        </View>
                    </View>
                </ScrollView>
            </View>
